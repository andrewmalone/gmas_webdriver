...
class SCR0233(Page):
    ...
    locators = {
        ...
        "ant_dollars": "xpath=//td[@class='strong'][text()='Subagreement attributes']/ancestor::table[2]//tr[21]/td[4]/table//tbody/tr/td[1]",
    ...
    _locators = {
        ...
        "account_row": "css=#subagreementAccountsDatatable_data tr",
        "account_total_dollars": "css=#subagreementAccountsDatatable_foot tr td:nth-child(2)",
        "account_total_balance": "css=#subagreementAccountsDatatable_foot tr td:nth-child(3)",
